...
> **Active backlog only.** Completed roadmaps §F–§BA (573 items) → [`docs/roadmap-archive.md`](docs/roadmap-archive.md) (anchors stripped — all were stale after repeated rewrites; symbols kept). This file tracks the **13 open + 8 parked** items that remain.

---

## Open work — 13 items (verified 2026-08-30)
...
**Phase 0 → Phase 1 → Phase 2 → Phase 3 → Phase 4a → Phase 5 → Phase 4b → Phase 6.** Phase 1 first (highest win/risk, no sim code); Phase 2 before Phase 4; Phase 4b last (only non-provably-identical item).
