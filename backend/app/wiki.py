...
LAW_HINTS_MD = {
    ...
    "nn_enabled": "micro-RNN 16→12→7 (295 weights) replaces the utility AI when on — 60Hz physics, 15Hz brain, evolved by selection (BA)",
    "nn_inference_hz": "NN inference frequency per second (15) — every 4th tick latched, zero-alloc buffers",
    "mutation_sigma": "Gaussian mutation σ for genome (0.08) — per-gene noise on crossover",
    "crossover_rate": "crossover rate (0.5) — uniform 50/50 parent blend",
