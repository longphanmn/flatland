...
PRESETS: dict[str, dict] = {
    "balance": dict(
        ...
        lifespan_mult=1.0,
        birth_enabled=True,
        adult_age=600.0,  # §BF-2 250→600 (0.5 days) — forces founders to survive a night before breeding
        mate_radius=10.0,
        mate_energy_min=22.0,
        birth_rate=0.075,
        boom_ramp_days=6.0,  # §BF-1
        boom_birth_floor=0.12,
        boom_cooldown_mult=3.0,  # §BF-3
        boom_energy_mult=2.5,  # §BF-4
        initial_season_offset=2,  # §BF-5 autumn start
        sex_ratio=0.5,
        mutation_rate=0.05,
        max_sides=24,
    ...
    "sustainable": dict(
        ...
        lifespan_mult=1.2,
        birth_enabled=True,
        adult_age=900.0,  # §BF-2 200→900 (0.75 days) — sustainable needs longer
        mate_radius=10.0,
        mate_energy_min=18.0,
        birth_rate=0.085,
        boom_ramp_days=6.0,
        boom_birth_floor=0.12,
        boom_cooldown_mult=3.0,
        boom_energy_mult=2.5,
        initial_season_offset=2,
        sex_ratio=0.5,
        mutation_rate=0.05,
        max_sides=24,
    ...
    "extinction": dict(
        ...
        mutation_rate=0.06,
        max_sides=24,
        birth_energy_cost=25.0,
        reproduction_cooldown=700,
    ...
    "boom": dict(
        ...
        birth_rate=0.18,
        boom_ramp_days=1.0,  # §BF boom preset: minimal ramp to allow rapid expansion test
        boom_birth_floor=0.50,
        boom_cooldown_mult=1.2,
        boom_energy_mult=1.2,
