...
UI_I18N = {
    "en": {
        ...
        "guide_link": "Guide",
        "footer": "Generated from live code — <code>Config</code> defaults + <code>GodLaws</code> + <code>app.routes</code>. See <a href=\"/guide\">/guide</a> for minimal guide. · Developed by <strong>Long Phan</strong> — <a href=\"mailto:long@minhnhan.in\">long@minhnhan.in</a> · <a href=\"https://minhnhan.in\">minhnhan.in</a> · Built with OpenCode & Antigravity",
        ...
        "laws_title": "# Laws of the Sphere\n\nEvery `GodLaws` field — type/range/default. Set via `POST /api/laws` or presets.",
    ...
    "vi": {
        ...
        "laws_title": "# Các Định luật của Thượng đế (The Sphere)\n\nTất cả các trường `GodLaws` — kiểu dữ liệu, phạm vi và giá trị mặc định. Thay đổi qua `POST /api/laws` hoặc chọn cấu hình mẫu.",
    ...
    "fr": {
        ...
        "laws_title": "# Lois de la Sphère (The Sphere)\n\nTous les champs de `GodLaws` — type, plage et valeur par défaut. Modifiables via `POST /api/laws` ou par préréglage.",
